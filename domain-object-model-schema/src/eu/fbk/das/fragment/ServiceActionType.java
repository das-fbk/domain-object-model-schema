...
import eu.fbk.das.annotation.CompensationType;
import eu.fbk.das.annotation.EffectType;
import eu.fbk.das.annotation.GoalType;
import eu.fbk.das.annotation.PreconditionType;
import eu.fbk.das.datatype.VariableType;
...
@XmlType(name = "ServiceActionType", propOrder = {
    "receiveGoal",
    "goal",
    "precondition",
    "effect",
...
@XmlSeeAlso({
    eu.fbk.das.fragment.Fragment.State.class,
    eu.fbk.das.fragment.Fragment.Action.class,
    eu.fbk.das.fragment.Fragment.Transition.Action.class
})
